...
const {index,upload,StuSingUp,DellNotificantion,ConfirmLogin,
       CheckStuReg,ShowDashbord,ShowChallan,Logout,SetRegistration,ShowFeePage,ShowStuEcard,ShowBusInfo,TrackBus,setRouteChangeApplication}= require('../controllers/StudentController');
...
router.post('/rouChangeApplication',setRouteChangeApplication);
