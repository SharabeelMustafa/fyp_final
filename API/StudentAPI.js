...
const { index, upload, StuSingUp, DellNotificantion, ConfirmLogin, CheckStuReg, ShowDashbord, ShowChallan, Logout, SetRegistration, getNotifications,ShowBusInfo,ShowStuEcard } = require('../controllers/StudentApiController');
...
router.post('/register', SetRegistration);
